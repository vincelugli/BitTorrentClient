...
def verify_piece(piece, infoDict, currentPiece):
    ...
    currentPieceDecoded = piecesDecoded[currentPiece*20:currentPiece*20 + 19]
    encodedPiece = bencode(currentPieceDecoded)
    hashedPiece = hashlib.sha1(encodedPiece).digest()
