...
def client():
    ...
    #filename = 'E:\Downloads\BitTorrentClient\Independence50.torrent'
    ...
    if (isMultiFile):
        ...
        f.close()
    #f.close()
    #print(os.path.getsize('E:\Downloads\BitTorrentClient\\' + infoDict['files'][currentFile-1]['path'][0]))
    # Message Requesting
        ...
        if ((lengthOfPiecesLeft[index] - blockSize) > 0 and (sizeOfFiles[currentFile] - blockSize) > 0):
            ...
            if (payload[0] == 7):
                ...
                if(verification):
                    ...
                    if (isMultiFile):
                        sizeOfFiles[currentFile] += lengthOfPiece
                    lengthOfPiecesLeft[index] += lengthOfPiece
...
def verify_piece(piece, infoDict, currentPiece):
    ...
    print('given: ' + hashedPiece)
    print('taken: ' + hashlib.sha1(piece).digest())
